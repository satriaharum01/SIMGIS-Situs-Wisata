...
@section('content')
<!-- End Navbar -->
<div class="container-fluid py-4" style="margin-bottom: 28%;">
    <div class="row">
            ...
            <div class="card">
                <div class="card-header p-3 pt-2">
                    ...
                    <div class="text-end pt-1">
                        <p class="text-sm mb-0 text-capitalize">Jumlah Wisata</p>
                        <h4 class="mb-0">{{$wisata}}</h4>
                    </div>
                </div>
